...
void lightupall () {
  ...
  for (int i = random(1, 255); i < 256 && i >= 0; i+=j) {
    ...
    if (contains13) {
      ...
      // digitalWrite(13, LOW);
      // delay(500);
      int jj = random(-2, 2); // sets the digital pin 13 on
      // delay(1000);            // waits for a second    
      // leds[(i * 6 + 1) % 256] = CRGB::Indigo;
      // leds[(i * 6 + 2) % 256] = CRGB::Indigo;
      // leds[(i * 6 + 3) % 256] = CRGB::Indigo;
      ...
      leds[round(i / 5 + 4) % 256] = CRGB::Amethyst; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains14) {
      ...
      leds[round(i * 4 / 5 + 5) % 256] = CRGB::Gray; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains15) {
      ...
      // leds[(i * 3 + 1) % 256] = CRGB::Maroon;
        ...
        leds[(i - 12) % 256] = CRGB::CadetBlue; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains16) {
      ...
      leds[(i / 10 + 5 * i) % 256] = CRGB::ForestGreen;  // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains17) {
      ...
      leds[(i * 4 + i * 3 + 4) % 256] = CRGB::Azure; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains18) {
      ...
      leds[(i + 15) % 256] = CRGB::HotPink; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains19) {
      ...
      leds[(i * 4 + i * 4 + 10) % 256] = CRGB::Gold; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains20) {
      ...
      // leds[(i * 3 + 1) % 256] = CRGB::Maroon;
        ...
        leds[(i - 12) % 256] = CRGB::LawnGreen; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains22) {
      ...
      leds[(round(pow(i, 3)) + 4) % 256] = CRGB::Green; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains23) {
      ...
      leds[abs(i - 49) % 256] = CRGB::FireBrick; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains24) {
      ...
      leds[(i + 50) % 256] = CRGB::MintCream; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
    ...
    if (contains25) {
      ...
      leds[(i + 35) % 256] = CRGB::LightSalmon; // sets the digital pin 13 off
      // delay(50);  
      FastLED.show();
      FastLED.clear();
      FastLED.show();
